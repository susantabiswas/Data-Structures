...
/*sol:Since inorder traversal of the BST gives a sorted array of elements ,so just like in array starting from
front and end,we do in BST.Store the Max and Mix values ,then if target value if greater ,in the left subtree increase the
value of min ,if the target is smaller in the right subtree ,increase the value of Max,do above till max+min=target
*/
#include<iostream>
using namespace std;
