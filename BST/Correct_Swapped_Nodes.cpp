...
/*first:stores the first wrong position
 ...
 During traversal "previous" stores the previous node ,if the previous node is greater than that node is swapped ,make it first
 then if we again find this then this time the current node is swapped ,store it
 */
